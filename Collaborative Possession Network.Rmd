...
Created functions for shot, dribble, and pass. Made it more organized and easier to repeat call the same action during the simulation function. Have not yet added what happens after an Orebound.
